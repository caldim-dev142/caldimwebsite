...
const productsData: Record<string, ProductInfo> = {
  calrims: {
    ...
    workflow: {
      headline: "CAL-RIMS — Recruitment Workflow & Candidate Journey",
      description: "This details the structured end-to-end recruitment workflow of CAL-RIMS. It outlines the journey of an applicant through the platform from their first submission to their first day on the job.",
      phases: [
        {
          name: "Phase 1: Ingestion & Screening",
          stages: [
            {
              number: 1,
              name: "Applied (Application Received)",
              action: "Ingestion",
              details: "Candidates submit applications manually via the jobs board, or resumes are auto-ingested directly from a monitored HR email box."
            },
            {
              number: 2,
              name: "Screened (AI Resume Parse)",
              action: "AI screening",
              details: "The system automatically extracts candidate work history, education, and technical competencies, assigning an automated fit-score."
            }
          ]
        },
        {
          name: "Phase 2: Evaluation & Interviews",
          stages: [
            {
              number: 3,
              name: "Interview Scheduled (AI Assessment)",
              action: "AI Evaluation",
              details: "Recruiters approve screened candidates. Candidates receive secure links to complete interactive online voice or text interviews."
            },
            {
              number: 4,
              name: "Interview Completed",
              action: "Analysis",
              details: "Dashboards update with metrics and scores. Recruiters choose to Direct Hire, Review Later, or host a Physical Interview."
            }
          ]
        },
        {
          name: "Phase 3: Selection & Offers",
          stages: [
            {
              number: 5,
              name: "Offer Sent",
              action: "Offer Portal",
              details: "HR inputs projected joining dates and issues official templates. Candidates receive links to accept or decline digitally."
            },
            {
              number: 6,
              name: "Offer Accepted",
              action: "Decision",
              details: "If the candidate declines, the flow ends in Offer Rejected. If they accept, they transition immediately to Offer Accepted."
            }
          ]
        },
        {
          ...
          stages: [
            {
              number: 7,
              name: "Onboarded (First-Day Ready)",
              action: "Verified",
              details: "New hires upload onboarding photos and verify details. HR validates documents and generates the corporate ID card."
            }
          ]
        }
      ]
      ...
      phases: [
        {
          ...
          stages: [
            ...
            },
            {
              ...
              details: "AI scans the drawings and extracts plates, hardware, structures, and raw raw materials in seconds."
            }
          ]
        },
        {
      ...
      <main id="main-content">
        ...
        {product.workflow && (
          <section className="py-24 bg-slate-900 text-white relative overflow-hidden border-t border-slate-800">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_50%_-20%,rgba(120,119,198,0.1),transparent)] pointer-events-none" />
            ...
            <div className="container-wide relative z-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 relative">
                ...
                {product.workflow.phases.map((phase, pIdx) => (
                  <div key={pIdx} className="relative z-10">
                    ...
                    <div className="flex flex-col gap-4">
                      {phase.stages.map((stage) => (
                        <div 
                          key={stage.number} 
                          className="p-5 rounded-2xl bg-[#0a1128]/80 border border-white/10 hover:border-slate-700 transition-all duration-300 relative group flex flex-col justify-between min-h-[160px]"
                        >
                          <div>
